...
import sys
sys.path.append("/home/ryuichi/tree")
from Other.related_work.octfusion.models.networks.dualoctree_networks.graph_vae import GraphVAE
...
class OctFusionModel(BaseModel):
    ...
    def initialize(self, opt):
        ...
        self.autoencoder: GraphVAE = load_dualoctree(conf = vq_conf, ckpt = opt.vq_ckpt, opt = opt)
